        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <a-alert type="warning" :style="{ marginTop: '24px' }">
            <span slot="message">
              ...
              <a href="https://github.com/sendya/ant-design-pro-vue/blob/master/src/config/default.js" target="_blank">src/config/default.js</a>
            </span>
          </a-alert>
        </div>
      </div>
...
export default {
  ...
  mounted () {
    ...
    if (this.colorWeak !== config.colorWeak) {
      this.updateColorWeak(this.colorWeak)
    }
  },
  methods: {
    showDrawer () {
  ...
  primaryColor: '${this.primaryColor}', // primary color of Adv Admin
